...
{\small GPA: 3.59，发表SCI论文2篇，华东师范大学学业奖学金2次， IEEE Student member\\
  主修课程: 人工智能的数学方法、数据挖掘与信息分析、GIS程序设计及软件应用}
\vspace{0.1cm}
\datedsubsection{
  {\large \textbf{合肥工业大学(211)}}，地理信息科学，\textit{理学学士}}{2018.09 - 2022.06}
{\small GPA: 2.99，国家励志奖学金，科技竞赛奖2次，软件著作权2个\\
...
\begin {itemize}
{\small
\item \textbf {工作内容:} 开发部门级日志系统，基于飞书JavaSDK与原生API，解决汽车终端日志获取难题，依托终端联网能力构建自动化日志处理体系，实现上下游协同。
 \vspace{0.1cm}
\item \textbf {核心功能:}
...
\datedsubsection{\textbf{洪涝预警及可视化平台}}{}
\begin{itemize}
  {\small
